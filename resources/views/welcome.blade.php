...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('landing/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">


    <!-- Additional CSS Files -->

    <link rel="stylesheet" href="{{ asset('landing/assets/css/fontawesome.css') }}">
    <link rel="stylesheet" href="{{ asset('landing/assets/css/templatemo-edu-meeting.css') }}">
...
<body>
    ...
    <section class="section main-banner" id="top" data-section="section1">
        <video autoplay muted loop id="bg-video">
            ...
            <source src="{{ asset('landing/assets/images/mama.mkv') }}" type="video/mp4" />
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="caption">
                            <h6>Hello </h6>
                            <h2>Welcome to Mama2Be</h2>
                            <p>Mama2Be is a web based application that helps pregnant disabled women through out there maternity
                                period
                            </p>
    ...
    <script src="{{ asset('landing/vendor/jquery/jquery.min.js') }}" defer></script>
    <script src="{{ asset('landing/vendor/bootstrap/js/bootstrap.bundle.min.js') }}" defer></script>
    <script src="{{ asset('landing/vendor/bootstrap/js/bootstrap.bundle.min.js') }}" defer></script>


    <script src="{{ asset('landing/assets/js/isotope.js') }}" defer></script>
    <script src="{{ asset('landing/assets/js/owl-carousel.js') }}" defer></script>
    <script src="{{ asset('landing/assets/js/lightbox.js') }}" defer></script>
    <script src="{{ asset('landing/assets/js/tabs.js') }}" defer></script>
    <script src="{{ asset('landing/assets/js/video.js') }}" defer></script>
    <script src="{{ asset('landing/assets/js/slick-slider.js') }}" defer></script>
    <script src="{{ asset('landing/assets/js/custom.js') }}" defer></script>
